 ...
 * Generated at: 2020-07-05 06:56:31 UTC
...
public final class consultaUsuarios_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(final javax.servlet.http.HttpServletRequest request, final javax.servlet.http.HttpServletResponse response)
    ...
    try {
      ...
      out.write("\t<script>\n");
      out.write("\t\tvar jsonVar;\n");
      out.write("\t      window.onload = (event) => {\n");
      out.write("\t      fetch('http://192.168.0.10:8080/consulta-usuarios/hello')\n");
      out.write("\t\t\t.then(response => response.json())\n");
      out.write("\t\t\t\t\t\t      .then(data => {\n");
      out.write("\t\t\t\t\t\t      jsonVar = data;\n");
      out.write("\t\t$('#table_id').DataTable( {\n");
      out.write("\t\t  data: jsonVar,\n");
      out.write("\t\t  columns: [\n");
      out.write("\t\t\t\t\t\t              { title: 'ID' },\n");
      out.write("\t\t\t\t\t\t              { title: 'Nombre' },\n");
      out.write("\t\t\t\t\t\t              { title: 'Edad' },\n");
      out.write("\t\t\t\t\t\t              { title: 'Email' },\n");
      out.write("\t\t\t\t\t\t              { title: 'Fecha de Registro' }\n");
      out.write("\t\t\t\t\t\t          ]\n");
      out.write("\t\t\t\t\t\t      } );\n");
      out.write("\t\t\t\t\t\t      });\n");
      out.write("\t      };\n");
      ...
      out.write("</head>\n");
      out.write("<body>\n");
      out.write("\t<table id=\"table_id\" class=\"display\"></table>\n");
      out.write("</body>\n");
      out.write("</html>\n");
